...
This API request is used to create Passbook Passes depending on how the Pass Template was created. 
...
barcodeValue (if "PassData=Dynamic" &amp; "Barcode=Allowed" &amp; "BarcodeType=Dynamic" &amp; "BarcodeValueSource=API" for Pass Template otherwise IGNORED)
<strong>Optional: </strong>
barcodeText (if "PassData=Dynamic" &amp; "Barcode = Allowed" &amp;&amp; "Barcode Alternate Text = API" for Pass Template otherwise IGNORED), 
