...
The email has unsubscribed from any campaign associated with the SMTP server you are using.<br/>
The email has filed a spam complaint.<br/>
The email bounced during a previous delivery.<br/>
